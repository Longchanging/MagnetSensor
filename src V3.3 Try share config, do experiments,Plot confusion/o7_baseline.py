...
from src.o2_config import test_ratio, train_tmp, predict_tmp, model_folder, whether_shuffle_train_and_test
...
def baseline_trainTest():  
    ...
    np.savetxt(model_folder + 'traditional_train_test_confusion_matrix.csv', f2)
