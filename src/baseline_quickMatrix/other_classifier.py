# coding:utf-8
'''
@time:    Created on  2018-04-17 20:11:31
@author:  Lanqing
@Func:    realData_LSTM.other_classifier
'''
...
# Parameters
learning_rate = .0000000005  # default 0.01
kernel = 'rbf'  # {'linear', 'rbf', 'poly', 'sigmoid', 'precomputed'} default 'rbf'
...
def main_TrainAndTest(filePath):  
    ...
    test_classifiers = ['KNN', 'LR', 'RF', 'DT','GBDT','AdaBoost']
    ...
    model = classifiers[model_name](X_train, y_train, train_wt)        
    ...
    print ('Not mine: final test: model: %s,accuracy: %f' % (model_sort[0], s1), 'matrix:', f2)

    return model_sort, scores_Save, max_score

main_TrainAndTest(after_pca_data)
