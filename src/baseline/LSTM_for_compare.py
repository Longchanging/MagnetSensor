# coding:utf-8
'''
@time:    Created on  2018-04-17 21:03:18
@author:  Lanqing
@Func:    realData_LSTM.LSTM_for_compare
'''
...
direc = '../../data/keep-point/compare/'
summaries_dir = '../../data/keep-point/compare/'
Model_folder = '../../data/model/compare/'
