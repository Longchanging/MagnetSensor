...
train_folder, test_folder, predict_folder = base + '/input/mac/', base + '/input/hp/', base + '/input/real_time_testing/'  # 机型
predict_keyword = ['realtime']
train_keyword = test_keyword = ['music', 'off', 'web', 'online', 'surfing']
