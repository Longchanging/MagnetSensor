...
'''
import numpy as np
from step1.config import input_folder, trainTestdifferent_category, train_percent2read_afterPCA_data, train_after_fft_data, \
    predict_folder, predict_different_category, predict_fft_data, \
