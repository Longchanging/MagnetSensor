...
def train_test(train_test_data_folder):
    '''
    ...
    data, label = main_prepare(train_test_data_folder)
    ...
    np.save(processed_train_folder + 'X_train.npy', X_train)
    np.save(processed_train_folder + 'y_train.npy', y_train)
    np.save(processed_train_folder + 'X_test.npy', X_validate)
    np.save(processed_train_folder + 'y_test.npy', y_validate)
    np.save(processed_test_folder + 'X_test.npy', X_test)
    np.save(processed_test_folder + 'y_test.npy', y_test)

    return

def predict(predict_data_folder):
    '''
    ...
    '''
    # read data from train_test_data_folder + 'after_pca_data.txt' / 'after_pca_label.txt'
    data, label = main_prepare(predict_data_folder)
    np.save(processed_predict_folder + 'X_test.npy', data)
    np.save(processed_predict_folder + 'y_test.npy', label)    
    return
