...
from o2_config import test_ratio, train_tmp, predict_tmp, model_folder,whether_shuffle_train_and_test
import numpy as np
...
def baseline_predict():
    ...
    labels_ = labels_.astype(int)
    print('Shape of predict data:', data.shape)
    np.savetxt(model_folder + 'best_model_predict_labels.txt', labels_)
    return
