...
from src.o2_config import train_batch_size, MAX_NB_VARIABLES, batch_size, NB_CLASS, \
    model_folder, train_tmp, epochs, n_splits, evaluation_ratio, whether_shuffle_train_and_test
...
def train_fcn():
    ...
    for train_index, test_index in skf_cv.split(X, y):
        ...
        model.fit(X_train, y_train, batch_size=train_batch_size, epochs=epochs, callbacks=callback_list,
