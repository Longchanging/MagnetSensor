...
### 此处添加文件相关信息 ###
train_keyword = ['05_work_word', '07_work_ppt', '08_social_wechat', '09_social_qq', '12_game_plants', '13_game_zuma', '14_game_candy', '15_game_minecraft', '16_picture_win3d', '17_chrome_surfing', '18_firefox_surfing', '19_chrome_gmail_work', '20_chrome_twitter', '21_chrome_youtube', '22_chrome_amazon']
train_folder = '../data//input//panhao_20180524/'
test_folder = '../data//input//panhao_20180524/'
predict_folder = '../data//input//panhao_20180524/'
train_tmp = '../data//tmp/panhao_20180524//tmp/train/'
test_tmp = '../data//tmp/panhao_20180524//tmp/test/'
predict_tmp = '../data//tmp/panhao_20180524//tmp/predict/'
train_tmp_test = '../data//tmp/panhao_20180524//tmp/train/test/'
model_folder = '../data//tmp/panhao_20180524//model/'
NB_CLASS = 15
